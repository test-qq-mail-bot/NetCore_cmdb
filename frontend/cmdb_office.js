/* CMDB - 办公家具资产 */
(function () {
    window.NC.registerPage('cmdb_office', {
        mixins: [window.NC.SF_MIXIN],
        template: `
        <div class="cmdb-page">
          <CmdbPageHeader title="办公家具" subtitle="办公桌 / 椅 / 柜 / 其他家具台账">
        ...
        methods: {
            ...
            async load() {
                try {
                    ...
                    const baseParams = { size: PAGE_SIZE, category: '办公家具' };
            ...
            openNew() { this.$refs.formDlg.open(null, { categories: ['办公家具'], defaultCategory: '办公家具' }); },
            openEdit(row) { this.$refs.formDlg.open(row, { categories: ['办公家具'] }); },
